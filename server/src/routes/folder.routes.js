...
import { getFolders, getFolder, createFolder, updateFolder, deleteFolder, getMyFolderAccess } from '../controllers/folder.controller.js';
...
router.get('/:folderId/my-access', authenticate, getMyFolderAccess);
router.get('/:folderId/documents', authenticate, getDocuments);
router.post('/:folderId/documents', authenticate, upload.single('file'), uploadDocument);
